...
export async function POST(request: Request) {
  ...
  const updates: { logo_path?: string; banner_path?: string; theme_preset:string; theme_primary:string; theme_accent:string; theme_background:string; theme_text:string } = { theme_preset, theme_primary, theme_accent, theme_background, theme_text };
